...
do
	...
	do
		...
		then
			...
			perl Grabar_L.pl Recibir_A I "El archivo $archivo fue rechazado por ser invalido"
		...
		then
			...
			then
				...
				then
					...
					perl Grabar_L.pl Recibir_A I "El archivo $archivo de reservas ha sido aceptado"
				else
					perl Mover_A.pl "$RUTA_ARCHIVO" "$RECHAZADOS" Recibir_A
					perl Grabar_L.pl Recibir_A I "El archivo $archivo fue rechazado por par id de Sala-correo invalido/inexistente"
				fi
			elif [ `expr $id % 2` -eq 1 ]
			then
				...
				then
					...
					perl Mover_A.pl "$RUTA_ARCHIVO" "$RECHAZADOS" Recibir_A
					perl Grabar_L.pl Recibir_A I "El archivo $archivo fue rechazado por par id de Obra-correo invalido/inexistente"
				fi
		...
		then
			...
			perl Grabar_L.pl Recibir_A I "El archivo de invitados  $archivo fue aceptado y movido a $REPOSITORIO"
		fi
